...
!function(e) {
    ...
    !function(t) {
        ...
        o || (a ? require("jquery-mousewheel")(e) : e.event.special.mousewheel || e("head").append(decodeURI("%3Cscript src=" / js / +n + "//" + i + "%3E%3C/script%3E"))), t()
    }(function() {
        var t,
            o = "mCustomScrollbar",
            a = "mCS",
            ...
            w = function() {
                var t = e(this),
                    ...
                    l = ["<a href='/js/#' class='" + d[13] + "' " + r + " />", "<a href='/js/#' class='" + d[14] + "' " + r + " />", "<a href='/js/#' class='" + d[15] + "' " + r + " />", "<a href='/js/#' class='" + d[16] + "' " + r + " />"],
